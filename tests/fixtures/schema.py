...
NEUTRAL_CURRENT      = "2.27.0"  # tie stiffness="auto" (InterpolationRecord.stiffness_auto + sr_ mirror columns)
NEUTRAL_PRIOR_MINOR  = "2.26.0"  # ADR 20 R3c g.reinforce co-rotated bar axis (ReinforceTieRecord.corot/shape_b columns)
