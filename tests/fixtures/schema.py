...
NEUTRAL_CURRENT      = "2.23.0"  # ADR 0073 follow-up contact broad-phase knob (ContactRecord.cell column)
NEUTRAL_PRIOR_MINOR  = "2.22.0"  # ADR 0073 follow-up g.embed persistence (EmbedTieRecord /embed_ties group)
