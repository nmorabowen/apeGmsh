...
NEUTRAL_CURRENT      = "2.15.0"  # ADR 0067 P5.1 embedded-reinforcement ties (/reinforce_ties group)
NEUTRAL_PRIOR_MINOR  = "2.14.0"  # ADR 0068 equation-tie enforce route (enforce column on interpolation + sr_enforce mirror)
