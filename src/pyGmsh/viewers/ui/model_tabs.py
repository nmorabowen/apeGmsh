...
class SelectionTreePanel:
        ...
        for dim in sorted(by_dim.keys(), reverse=True):
            ...
            for tag in tags:
                ...
                root = self._make_item(
                    self._tree, dim_label, tag, color, bold=True,
                )
                ...
                try:
                    ...
                    for cd, ct in children:
                        ...
                        child = self._make_item(
                            root, child_label, ct, child_color,
                        )
                        ...
                        if cd > 0:
                            try:
                                ...
                                for sd, st in sub_children:
                                    ...
                                    self._make_item(child, sl, st, sc)
                            except Exception:
                                pass
                except Exception:
                    pass
    ...
    def _make_item(self, parent, label, tag, color, bold=False):
